    ...
    <Form layout="vertical">
      <Form.Item label="Disclaimer Text">
        <Input.TextArea
          ...
          onChange={(e) =>
            setProp((props: any) => (props.disclaimerText = e.target.value))
          }
          rows={4}
        />
      </Form.Item>
      <Form.Item label="Physical Address">
        <Input
          ...
          onChange={(e) =>
            setProp((props: any) => (props.physicalAddress = e.target.value))
          }
        />
      </Form.Item>
      <Form.Item label="Support Email">
        <Input
          ...
          onChange={(e) =>
            setProp((props: any) => (props.supportEmail = e.target.value))
          }
        />
      </Form.Item>
      ...
      <Form.Item label="Privacy Link">
        <Input
          ...
          onChange={(e) =>
            setProp((props: any) => (props.privacyLink = e.target.value))
          }
        />
      </Form.Item>
      <Form.Item label="Copyright Text">
        <Input
          ...
          onChange={(e) =>
            setProp((props: any) => (props.copyrightText = e.target.value))
          }
        />
      </Form.Item>
