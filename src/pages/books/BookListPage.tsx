      ...
      <Layout style={{ minHeight: "100vh", background: colors.white }}>
        ...
        >
          ...
          >
            <Text
              strong
              style={{ color: colors.slate600, cursor: "pointer" }}
              onClick={() => navigate("/")}
            >
              Khóa học
            </Text>
              ...
              <Row gutter={[40, 40]} align="middle">
                <Col xs={24} md={14}>
                  ...
                  >
                    ...
                    >
                      Khám phá bộ sưu tập sách điện tử chuyên sâu về đầu tư,
                      quản lý tài chính và phát triển bản thân được biên soạn
        ...
        >
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            ...
            >
              ...
              >
                <MdSchool style={{ color: colors.white, fontSize: "18px" }} />
              </div>
              <Title
                level={4}
                style={{ margin: 0, fontWeight: 800, color: colors.white }}
              >
                SRM <span style={{ color: colors.primary }}>FIN-EDU</span>
              </Title>
            </div>
            ...
            />
            <div style={{ color: colors.slate600, fontSize: "14px" }}>
